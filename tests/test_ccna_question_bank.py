...
class CcnaQuestionBankTests(unittest.TestCase):
    ...
    def test_app_supports_answer_explanations_and_review_filter(self):
        ...
        self.assertIn("function setChoiceContent", app)
        self.assertIn("function createCodeBlock", app)
        self.assertIn('text.includes("\\n")', app)
        self.assertIn('document.createElement("code")', app)
        self.assertIn("String.fromCharCode(65 + displayIndex)", app)
        html = CCNA_HTML.read_text(encoding="utf-8")
