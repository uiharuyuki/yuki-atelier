...
- 技術ジャンルのロゴ（Git / Vue.js / JavaScript など）は **Devicon CDN** (`cdn.jsdelivr.net/gh/devicons/devicon@v2.16.0/icons/<tech>/<tech>-original.svg`) の公式ロゴを `<img>` で読み込む（PNG のキャラ絵ではなくブランドロゴを使う）。
